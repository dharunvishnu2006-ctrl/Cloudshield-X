...
def plot_top_ips(grouped_df: pd.DataFrame,
...
def plot_request_distribution(
        grouped_df: pd.DataFrame) -> plt.Figure:
    if grouped_df.empty:
        return None
    ...
    sns.boxplot(y=grouped_df["count"],
