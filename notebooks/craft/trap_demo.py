...
alerts = [
    Alert(ip="203.0.113.45", reason="brute force",
          count=5, severity="high", at="2026-07-29"),
    Alert(ip="117.55.8.20", reason="scanning",
          count=2, severity="low", at="2026-07-29"),
    Alert(ip="49.205.10.8", reason="rate limit",
          count=8, severity="critical", at="2026-07-29"),
]

severity_order = {"low": 1, "medium": 2,
                  "high": 3, "critical": 4}
...
events = [
    LogEvent(ip="203.0.113.45", timestamp="2026-07-29",
             method="POST", path="/api/login",
             status=401, user_agent="Mozilla"),
    LogEvent(ip="49.205.10.8", timestamp="2026-07-29",
             method="GET", path="/api/orders",
             status=200, user_agent="Chrome"),
    LogEvent(ip="117.55.8.20", timestamp="2026-07-29",
             method="POST", path="/api/login",
             status=403, user_agent="curl"),                  
]
